...
<body>
  ...
  <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
    <div class="col-md-6 px-0">
      <h1 class="display-4 font-italic">Food Traceability Solution</h1>
      <p class="lead my-3">Get precise information, about your food, explore how
                          food travels through the supply chain before reaching
                          you and the conditions under which your food is grown.
      </p>
  ...
  <div class="">
    ...
    <p class="text-center">
      ...
      food safety issues when they occur.
    </p>
  </div>
